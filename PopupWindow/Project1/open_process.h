...
public:
	...
	static BOOL CreateProcessAsActivedUser(
		LPTSTR psCmd,
		LPTSTR psCurrentDir)
	{
		if (psCmd == NULL)
	...
	static BOOL CreateAdminProcessAsActivedUser(
		LPTSTR psCmd,
		LPTSTR psCurrentDir)
	{
		if (psCmd == NULL)
	...
	static BOOL CreateProcessAsActivedUserOnVista(
		LPTSTR psCmd,
		LPTSTR psCurrentDir)
	{
		if (psCmd == NULL)
	...
	BOOL CreateProcessAsActivedUserOnVistaTillExit(
		LPTSTR psCmd,
		LPTSTR psCurrentDir)
	{
		if (psCmd == NULL)
	...
	BOOL CreateProcessAsActivedUserBySession(
		LPTSTR pszCmd,
	...
	BOOL CreateProcessAsActivedUserOnVistaBySession(
		LPTSTR pszCmd,
		LPTSTR pszCurrentDir,
		DWORD dwSession)
	{
	...
	static BOOL CreateAdminProcess(
	...
	BOOL CreateProcessUserToTillExit(
		LPTSTR lpApplicationName,
	...
	static int GetActiveUserTokenOnVista(
		HANDLE* phToken)
	{
	...
	static bool IsActiveUserTokenAdmin(
		HANDLE hToken)
	{
		bool bResult = false;
		PSID pAdminSid = NULL;
	...
	static int GetActiveUserTokenFromSystem(
		HANDLE* phToken)
	{
	...
	int GetActiveUserTokenFromSession(
		HANDLE* phToken,
		DWORD dwSession)
	{
		if (phToken == NULL)
	...
	int GetActiveUserTokenOnVistaFromSession(
		HANDLE* phToken,
		DWORD dwSession)
	{
		HANDLE hTokenThis = NULL;
	...
	static int GetActiveUserTokenFromXP(
		HANDLE* phToken)
	{
		DWORD dwSessionId = 0;
	...
	static int GetActiveUserTokenFrom2k(
		HANDLE* phToken)
	{
	...
	static int GetActiveSessionFromXP(
		DWORD& dwSession)
	{
		PWTS_SESSION_INFO pSessionInfoArray = NULL;
		DWORD dwCount = 0;
